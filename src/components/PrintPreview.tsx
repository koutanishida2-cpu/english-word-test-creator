      ...
      <div className="print-page bg-white w-[210mm] h-[297mm] p-[10mm] shadow-lg border border-slate-200 mx-auto box-sizing-border-box flex flex-col justify-between select-none">
        <div>
          ...
          <div className="w-full">
            <table className="w-full border-collapse border border-black text-[11px] text-black table-fixed">
              <thead>
                <tr className="bg-slate-50 border-b border-black">
                  <th className="border-r border-black p-1 text-center font-bold w-[12%]">単語番号</th>
                  <th className="border-r border-black p-1 text-left font-bold w-[38%]">英単語</th>
                  <th className="p-1 text-left font-bold w-[50%]">答え</th>
                </tr>
              </thead>
              <tbody>
                {leftColumnWords.map((word) => (
                  <tr key={word.number} className="border-b border-black h-[8.2mm]">
                    <td className="border-r border-black p-1 text-center font-mono font-medium truncate">{word.number}</td>
                    <td className="border-r border-black p-1 font-medium font-sans break-words whitespace-normal leading-tight">{word.english}</td>
                    <td className="p-1 answer text-red-600 font-semibold break-words whitespace-normal leading-tight">{word.japanese}</td>
                  </tr>
                ))}
              </tbody>
            </table>
